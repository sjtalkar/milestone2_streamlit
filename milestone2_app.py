...
from pages import motivation, datasets, supervised_learning, unsupervised_learning, deeplearning, conclusion_ethics, credits, explainability 
...
app.add_page("Explainability", explainability.app)
